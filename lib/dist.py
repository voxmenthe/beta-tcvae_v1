...
class Normal(nn.Module):
    ...
    #@@# whatever std and mean are - you sample from whatever dist that currently
    #@@# represents
    ...
    def NLL(self, params, sample_params=None):
        ...
        #@@# Given you know the parameters of your Gaussian you can 
        #@@# compute the negative log likelihood of some samples
        """
        mu, logsigma = self._check_inputs(None, params)
